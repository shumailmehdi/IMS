                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <div style="font-size:100px">
                                <h1><img src="<?=base_url()?>public/images/logo-icon.png" alt="IMS" height="100px"></h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" style="color:white">
                            Designed and Developed by <a href="javascript:void(0)" target='_blank' class="text-primary">Shumail Mehdi</a> (2018)
                        </div>
                    </div>
                </div>
            </div>
